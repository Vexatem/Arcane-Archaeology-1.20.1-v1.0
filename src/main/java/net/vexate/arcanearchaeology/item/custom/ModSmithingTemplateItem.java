...
public class ModSmithingTemplateItem extends SmithingTemplateItem {
    ...
    static {
        ...
        EMPTY_SLOT_BRUSH_TEXTURE = new Identifier(ArcaneArchaeology.MOD_ID, "item/empty_slot_brush");
        EMPTY_SLOT_PRISM_TEXTURE = new Identifier(ArcaneArchaeology.MOD_ID, "item/empty_slot_prism");
    }

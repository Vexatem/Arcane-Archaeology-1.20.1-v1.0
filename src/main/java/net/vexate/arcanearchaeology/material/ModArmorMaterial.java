package net.vexate.arcanearchaeology.material;
...
public enum ModArmorMaterial implements ArmorMaterial {
    AZURE("azure", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.AZURE_CRYSTAL_SHARD));
    ...
    public String getName() {
        return ArcaneArchaeology.MOD_ID + ":" + this.name;
    }
